...
def validate_colouring(graph, colouring):
    """Check if colouring is a valid colouring of graph. Return bool."""
...
def product_brute_force_colouring(graph):
    """Return dict colouring of graph done by prodcut brute force method.
    ...
    while True:
        ...
        for colouring_option in options:
            ...
            if colours - 1 in colouring_option:
                ...
                if validate_colouring(graph, colouring):
                    return colouring
...
def custom_brute_force_colouring(graph):
    """Return dict colouring of graph done by acustom brute force method.
    ...
    while True:
        if colours <= size:
            ...
            # colours than there are vertices in the graph
